...
![LANDSAT image showing the abandoned paleochannel that are marked by their avulsion year and the flooded areas during the 2008 Kosi Flood (shaded in red). A continuous avulsion of Kosi to the west to its current location is observed since 1760 the earliest .](images/Kosi_avulsion.jpg){fig-align="center"}
...
This project did not outline the use of remote sensing techniques in post-disaster reconstruction and flood management; therefore, I am going to suggest the application of MODIS (Moderate Resolution Imaging Spectroradiometer) to enhance the precision and efficiency for post-disaster reconstructions and disaster risks reductions [@earthdata]. This suggestion is inspred by @ARVIND2016575, where they proposed the use of satellite images from different months to identify and predict the flood extents for the next possible flood occurrence. They successfully applied to one of the flood events in 2009 in southern part of India (across various local regions), to identify the extent of flooded and non-flooded areas through remote sensing. MODIS can monitor changes in biosphere -- land cover; atmosphere -- cloud cover (potential rainfall); hydrosphere -- water level/ extent of water body; cryosphere -- extent of snow cover [@modis2018]. In addition to that, remotes sensing is beneficial for monitoring areas that are still under the impact of flood inundation for post-disaster risks reudction. Therefore, MODIS would be undoubtedly beneficial for the recovery project and to link with the global agendas and goals:
...
Remote sensing is an extremely useful technique in monitoring environmental changes (as I said before), the question I would like to raise is that: why some of the countries do not incorporate remote sensing into their policy scopes for monitoring changes? what makes them refuses to deploy remote sensing? Well, I mean remote sensing is an excellent tool for spatial management but it is kind of costly, it might not be affordable for every countries/ local authorities. To apply remote sensing in policy development and monitoring, first we --- the professional (data analyst) requires funding for that (including salary, data procurement, data processing, and product output fees); secondly we also need time for data processing (that could be a long and tiring time for both professionals and local authorities). There are many considerations and negotiations between government, professionals (could be invidual or academia), and local citizens to go through, especially about the costs for deploying remote sensing and the use of remote sensing products for regional development e.g.., what policy decision to be made regrading the product. IT IS A COMPLICATED MOVE, it's never be easy.

For my case study in Bihar (Kosi River), India, I think is it absolutely reasonable to deploy remote sensing for the recovery project. Reasons are 1). we never know when will be the next breach happened 2). we have to understand the exposure of local communities to flood risks 3). we have to identify areas for immediate restoration. It is important for us to closely and continuously monitor flood risks through remotely sensing changes in physical environment for pre- and post-disaster risks reductions.
