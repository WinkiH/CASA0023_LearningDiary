...
![Fraction map from subpixel analysis showing the changes in land cover between 2005 (a-d) and 2009 (e-f). From left to right are: vegetation, high-albedo objects, low-albedo objects, soil [@doi:10.1080/10095020.2014.889268].](images/fractionmap.jpeg)
...
As continue from last week classification, this week seems to be much more easier although it is still -- complicated. The OBIA and sub pixel analysis is still fine for me as it is quite straightforward in terms of their concepts, accuracy assessment is where the complexity of information and concept being drawn in. It is fascinating there is no definite answer on how should a "good" accuracy assessment looks like as mentioned in the presentation "there is no single right choice for accuracy measurement". This means we have to justify our choices for accuracy assessment accordingly and wisely. This is where I realised the most important part in building a machine learning model is not simply focusing on justifying how the model should be built, but also how should we validate our model through performing a series of accuracy assessment. If we failed to do to, model accuracy would become a limitations of our study, making our results not reliable.
