...
![Wavelength of different bands in SAR](images/SARwavelength.png)
...
![Graph showing different polarisation from different objects.](images/SARPolarization.jpg)
...
SAR image is just another level...! It does not only provide a high resolution but also not limited by weather condition (they can pass through clouds)! It is extremely useful for remotely sensing places with cloud covered all the time e.g., the tropical areas (Indonesia, Singapore, Brazil... etc.) where there are rapid and frequent cloud formation. I was, again, amazed by how far the technology could go in remote sensing! It facilitates monitoring in environmental changes in tropical countries, where natural disaster and human influence e.g., deforestation are rapidly taking place. The availability of SAR would definitely be beneficial to those countries (or at least research around those regions). Another reason for SAR being on the next level is that SAR allows the generation of inteferogram, therefore, monitoring land displacement. It is a breakthrough in the monitoring of vertical land movement (VLM) brought by both human and physical factors, just by comparing two satellite imagery across different times. Satellite missions with SAR on-board e.g., Sentinel-1/ ALOS have made many positive contributions in monitoring displacement of land. That's why I am saying SAR is on the next level!
