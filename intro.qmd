...
Remote sensing is usually achieved using remote sensors that are on board with the satellites or aircrafts. It is also a form of cloud computing data source that requires certain computational technologies to complete remote sensing. The most well-known service provider is the National Aeronautics and Space Administration (NASA), providing numerous open-source database for easy public assess [@earthinformationcentre2024]. Remote sensing has paved the way to monitor changes in remote areas e.g., deforestation in Amazon Forest and changes in relation to climate warming [@yang2013].
...
After the lecture and practical sessions, I am more confident in explaining the methodology involved in remote sensing, such as how they actually works. Although it takes some time for me to digest through the content, I think this lecture has laid down a foundation for understanding the application of remote sensing. I was amazed by how remote sensing can benefit from the advanced technological development in this modern world, from in-situ monitoring stations/ field studies to remotely sensing environment just by clicking a dew buttons and downloading the required data. Remote sensing has definitely made our lives more easier in terms of monitoring environmental change, especially under the context of rapid global warming as we can see that remote sensing techniques are now being widely used in disaster risks reduction in different UN reports e.g., AR5 (Assessment Report 5).
